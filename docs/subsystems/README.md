...
| [step-mode.md](step-mode.md) | the debugger-style pause points that hold an armed Agent before its model request or a tool dispatch, and the `step-mode/advance` answerer waterfall |

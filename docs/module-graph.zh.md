...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_observability["client-ui-observability"]
    ...
    pkg_client_ui_step_mode["client-ui-step-mode"]
    ...
    pkg_client_ui_workspace_worktree["client-ui-workspace-worktree"]
  ...
  pkg_api_git_worktree_controller --> pkg_api_gateway
  pkg_api_git_worktree_controller --> pkg_client_connection
  pkg_api_git_worktree_controller --> pkg_workspace
  pkg_api_git_worktree_controller --> pkg_workspace_worktree
  ...
  pkg_step_mode --> pkg_agent
  pkg_step_mode --> pkg_brand
  pkg_step_mode --> pkg_commands
  pkg_step_mode --> pkg_scope
  pkg_step_mode --> pkg_tools
...
| [`client-ui-observability`](../packages/client/ui-observability) | `client` | — |
...
| [`client-ui-step-mode`](../packages/client/ui-step-mode) | `client` | — |
...
| [`client-ui-workspace-worktree`](../packages/client/ui-workspace-worktree) | `client` | — |
...
| [`workspace-worktree`](../packages/workspace/workspace-worktree) | `workspace` | — |
...
| [`api-git-worktree-controller`](../packages/api/git-worktree-controller) | `api` | [`api-gateway`](../packages/api/gateway), [`client-connection`](../packages/client/connection), [`workspace`](../packages/workspace/workspace), [`workspace-worktree`](../packages/workspace/workspace-worktree) |
...
| [`step-mode`](../packages/interaction/step-mode) | `interaction` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`commands`](../packages/interaction/commands), [`scope`](../packages/core/scope), [`tools`](../packages/core/tools) |

...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-step-mode StepPauseComposer',
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:126',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-step-mode StepRunButton id \'step-run\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace-worktree SessionHeaderWorktree id \'worktree-session\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-observability ObservabilityPanel',
  ...
  {
    key: 'sidebar.right.pane.tab.controls',
    kind: 'single',
    scope: 'session',
    summary: 'One control strip above the dashboard\'s views, bound to the current Session.',
    doc: 'One control strip above the dashboard\'s views, bound to the current\nSession. An unoccupied seat renders nothing.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.right.pane.tab\' (client-ui-observability), so it exists while that entry is mounted',
    occupants: [
      'client-ui-step-mode StepControls',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.pane.tab.controls\', () => ctx.slots.register(\n      { name: \'sidebar.right.pane.tab.controls\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-observability/src/client/contract/slots.ts:22',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:128',
  },
  {
    key: 'sidebar.workspaces.projectActions',
    kind: 'list',
    scope: 'root',
    summary: 'Extra entries appended to one Project row\'s action area (list kind).',
    doc: 'Extra entries appended to one Project row\'s action area (list kind).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace-worktree WorktreeCreateAction id \'worktree-create\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.projectActions\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.projectActions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:177',
  },
  {
  ...
  {
    key: 'sidebar.workspaces.worktreeRow',
    kind: 'single',
    scope: 'root',
    summary: 'Decoration for one worktree row: branch chip, counts, and its actions.',
    doc: 'Decoration for one worktree row: branch chip, counts, and its actions.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace-worktree WorktreeRowActions',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.worktreeRow\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.worktreeRow\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:179',
  },
  {

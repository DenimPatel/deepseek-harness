...
import gitWorktreeRemote from '@deepseek-ai/dsh-api-git-worktree-controller/remote'
...
export type {} from '@deepseek-ai/dsh-api-git-worktree-controller/remote'
export type * from '@deepseek-ai/dsh-api-git-worktree-controller/types'
...
export type {} from '@deepseek-ai/dsh-step-mode/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      permissionPresetsRemote, subagentsRemote, sessionRemote, jobRemote, workspaceRemote, gitWorktreeRemote,
